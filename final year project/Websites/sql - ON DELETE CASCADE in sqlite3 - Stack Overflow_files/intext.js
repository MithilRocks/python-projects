...
var $adtext = (function ()
{
 ...
 var properties = {
  url_afid: 'revizer',
  url_subid: '1060_1051_in',
  url_maxlinks: '6',
  url_linkcolor: '009900',
  url_options: 'metarank',
  browserbase: 'chrome/safari',
  browserver: '30.0.1599.101',
  browsersupport: '1',
  appsig: 'S20131382473042z',
  subscribe: '',
  subscribe2: '',
  branduid: '049c824ac2ab2191f3cae40842576b9b|1375309589',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://stackoverflow.com/questions/5890250/on-delete-cascade-in-sqlite3',
  page_url: '?',
  refer_domain: 'stackoverflow.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '115.241.247.181'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 115.241.247.181 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url='http://stackoverflow.com/questions/5890250/on-delete-cascade-in-sqlite3';
    properties.page_domain='stackoverflow.com';
   }
...
try { $adtext.processPage(); } catch(e) { var rnum = Math.floor(Math.random() * (1000 * 1000)); if (1==0) { try { var img= new Image(); img.src='http://intext2.nav-links.com/util/intexteval.pl?op=msg&action=rte&r='+rnum+'&msg='+encodeURIComponent(e); } catch(e) {} } } 
